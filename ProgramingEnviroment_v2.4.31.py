# filename: ProgramingEnviroment_v2.4.31.py
...
class ProgramingEnviromentApp:
    ...
    def setup_ui(self):
        ...
        tk.Label(code_header, text="Source Code (Auto-dependency scan enabled):", bg="#f8f9fa", font=("Segoe UI", 9, "bold")).pack(side="left")
