# filename: ProgramingEnviroment_v2.1.1.py
...
class ProgramingEnviromentApp:
    ...
    def run_pipeline(self):
        ...
        try:
            self.log("--- Starting Pipeline v2.1.1 ---")
    ...
    def execute_build(self, target_dir, file_name):
        ...
        if process.returncode != 0:
            raise Exception("PyInstaller process failed. Check log for details.")
