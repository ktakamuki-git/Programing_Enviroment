# filename: ProgramingEnviroment_v3.2.1.py
    ...
    def run_gemini_monitor(self):
        ...
        with sync_playwright() as p:
            try:
                ...
                # エラー回避のため引数をよりシンプルに調整
                context = p.chromium.launch_persistent_context(
                    user_data_dir=session_dir,
                    headless=False,
                    no_viewport=True, # 最大化するためにビューポート固定をオフ
                ...
                self.log("TIP: Another browser might be using the session. Check Task Manager.", "info")
                self.sync_active = False
