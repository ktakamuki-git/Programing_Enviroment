# filename: ProgramingEnviroment_v2.4.0.py
...
class ProgramingEnviromentApp:
    ...
    def check_and_install_dependencies(self, code):
        ...
        # 除外リスト（標準ライブラリや既知の組み込み）
        exclude = sys.builtin_module_names | {"tkinter", "os", "sys", "re", "json", "threading", "subprocess", "shutil", "datetime", "git", "importlib", "time"}
