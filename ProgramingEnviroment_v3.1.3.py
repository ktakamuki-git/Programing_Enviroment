# filename: ProgramingEnviroment_v3.1.3.py
...
class ProgramingEnviromentApp:
    ...
    def run_gemini_monitor(self):
        ...
        with sync_playwright() as p:
            try:
                self.log("Playwright engine started. Launching browser...", "sync")
                # headless=False を明示し、かつタイムアウト設定を緩和
                ...
                self.log("Ready! Monitoring chat for new code blocks...", "success")
    ...
    def update_code_from_sync(self, content):
        ...
        self.log("Sync Success: New code imported to editor.", "success")
        self.root.bell()
