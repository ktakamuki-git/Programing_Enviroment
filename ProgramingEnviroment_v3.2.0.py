# filename: ProgramingEnviroment_v3.2.0.py
...
class ProgramingEnviromentApp:
    ...
    def run_gemini_monitor(self):
        ...
        with sync_playwright() as p:
            try:
                self.log("Launching maximized browser...", "sync")
                # no_viewport=True でサイズ固定を解除, argsに最大化オプションを追加
                ...
                self.log("Sync Active! Enjoy the full-screen experience.", "success")
