# filename: ProgramingEnviroment_v3.1.9.py
...
class ProgramingEnviromentApp:
    ...
    def run_gemini_monitor(self):
        ...
        with sync_playwright() as p:
            try:
                self.log(f"Launching with Session: {session_dir}", "sync")
                # launch_persistent_context を使うことでログイン情報を維持
                ...
                self.log("Sync Active! Session remembered.", "success")
